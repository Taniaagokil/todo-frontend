...
export default function TodoItem({ todo, onToggle, onDelete }: TodoItemProps) {
  return (
    <li
      className={`p-4 rounded-xl border flex items-center justify-between gap-3 transition-all duration-200 ${todo.completed ? 'bg-success-10/20 border-success-20' : 'bg-white border-gray-100 hover:border-primary-70/40'}`}
    >
